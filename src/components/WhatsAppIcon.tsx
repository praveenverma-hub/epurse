// =============================================================================
// WhatsAppIcon — the one WhatsApp glyph. Extracted from LentBorrowedScreen the
// moment a second caller (GroupDetailScreen's per-member "Request" button)
// needed the identical mark, rather than a second copy of the SVG paths.
// =============================================================================
import React from 'react';
import Svg, { Path } from 'react-native-svg';

export default function WhatsAppIcon({ size = 17 }: { size?: number }) {
  return (
